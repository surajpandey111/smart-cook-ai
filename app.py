...
# --- Credits Section ---
st.markdown('<p style="text-align: center; color: #4a5568;">Developed by <b>Suraj Kumar Pandey</b> under mentorship of <b> Dr. Ashok Kumar Yadav Sir </b></p>', unsafe_allow_html=True)
